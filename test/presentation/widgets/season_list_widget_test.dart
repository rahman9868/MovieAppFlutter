...
class MockTvShowEpisodeBloc
    extends MockBloc<TvShowEpisodeEvent, TvShowEpisodeState>
  ...
  group('SeasonsList Widget Tests', () {
    testWidgets('page should nothing when empty', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
          makeTestableWidget(SeasonsList(tvShowDetail: testTvShowDetail)));
    ...
    testWidgets('Renders loading state', (WidgetTester tester) async {
      when(() => mockTvShowEpisodeBloc.state)
          .thenReturn(TvShowEpisodesLoadingState());
    ...
    testWidgets('Renders success state', (WidgetTester tester) async {
      when(() => mockTvShowEpisodeBloc.state).thenReturn(
          EpisodesTvShowSuccessState(
              testEpisodesMap, testTvShowDetail, testIsExpandedMap));
    ...
    testWidgets('Renders error state', (WidgetTester tester) async {
      when(() => mockTvShowEpisodeBloc.state)
          .thenReturn(EpisodesTvShowErrorState('Error message'));
