...
class TvShowRecommendationListBloc extends Bloc<TvShowRecommendationListEvent, TvShowRecommendationListState> {
  final GetTvShowRecommendations getTvShowRecommendations;

  TvShowRecommendationListBloc(this.getTvShowRecommendations) : super(TvShowRecommendationListInitialState()) {
