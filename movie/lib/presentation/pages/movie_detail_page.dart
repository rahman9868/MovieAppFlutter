...
import 'package:movie/presentation/bloc/recommendations/movie_recommendations_list_event.dart';
import 'package:movie/presentation/bloc/recommendations/movie_recommendations_list_state.dart';
...
class _MovieDetailPageState extends State<MovieDetailPage> {
  ...
  void initState() {
    ...
    Future.microtask(() {
      ...
      context
          .read<MovieRecommendationListBloc>()
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            BlocBuilder<MovieRecommendationListBloc,
                                MovieRecommendationListState>(
                              builder: (context, state) {
                                if (state
                                    is MovieRecommendationListLoadingState) {
                                  return const Center(
                                    child: CircularProgressIndicator(),
                                  );
                                } else if (state
                                    is MovieRecommendationListErrorState) {
                                  return Center(child: Text(state.message));
                                } else if (state
                                    is MovieRecommendationListLoadedState) {
                                  return SizedBox(
                                    height: 150,
